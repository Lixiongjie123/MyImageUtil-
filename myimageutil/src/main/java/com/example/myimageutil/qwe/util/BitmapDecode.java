...
import static com.example.myimageutil.qwe.down.cache.BitmapPool.getInstance;
...
public final class BitmapDecode {
     ...
     * @return
     */
    public static CountDrawable decodeRequestBitmap(InputStream inputStream, InputStream finalStream, int requestWidth, int requestHeight){
        ...
        if (bitmapSizeMap != null){
            ...
            if (options != null){
                ...
                return new CountDrawable(finalBitmap);
            }
        }
     ...
     * @return
     */
    public static CountDrawable decodeRequestBitmap(InputStream inputStream, int requestWidth, int requestHeight){
     ...
     * @return
     */
    public static CountDrawable decodeRequestBitmap(String filePath, int requestWidth, int requestHeight){
        final Map<Integer, Integer> bitmapSizeMap = isInRouteMap(requestWidth, requestHeight);
        final Bitmap finalBitmap;
        BitmapFactory.Options options;
        if (bitmapSizeMap != null){
     ...
     * @return
     */
    public static CountDrawable decodeRequestBitmap(Resources r, int resId, int requestWidth, int requestHeight){
        final Map<Integer, Integer> bitmapSizeMap = isInRouteMap(requestWidth, requestHeight);
        final Bitmap finalBitmap;
        BitmapFactory.Options options;
        if (bitmapSizeMap != null){
