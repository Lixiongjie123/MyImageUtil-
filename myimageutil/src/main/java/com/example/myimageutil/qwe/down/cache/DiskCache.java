...
import com.example.myimageutil.qwe.util.BitmapDecode;
...
public class DiskCache implements ImageCache {
    ...
    @Override
    public void put(String url, CountDrawable drawable) {
    ...
    public CountDrawable get(String url, int width, int height) {
        ...
        try {
            if(mDiskLruCache.get(key) == null) {
                ...
                CountDrawable drawable = BitmapDecode.decodeRequestBitmap(inputStream, width, height);
